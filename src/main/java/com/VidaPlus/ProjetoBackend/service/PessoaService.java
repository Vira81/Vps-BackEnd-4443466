...
public class PessoaService {
	...
	/**
	 * Atualiza os dados pessoais do usuario. Por padrão todos os campos são null,
	 * no momento que o usuario foi criado. NotNull após essa atualização
	 */
	@Autowired
	...
	public UsuarioSaidaDto minhaConta() {
		UsuarioEntity usuario = usuarioRepository.findById(login.getUsuarioLogado().getId()).orElseThrow();
